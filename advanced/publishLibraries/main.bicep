// Executed commands: 
// az ts create --name FltDemoCosmosDbAccount --location westeurope  --display-name "Cosmos DB account" --description "This template spec creates a Cosmos DB account that meets our company's requirements." --version 1.0 --template-file .\advanced\publishLibraries\main.bicep
// az ts create --name FltDemoCosmosDbAccount --location westeurope  --display-name "Cosmos DB account" --description "This template spec creates a Cosmos DB account that meets our company's requirements." --version 2.0 --template-file .\advanced\publishLibraries\main.bicep
